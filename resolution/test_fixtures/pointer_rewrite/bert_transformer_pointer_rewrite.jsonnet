// local variables
// reader相关参数
local model_name="adabrain/tests/data/base_bert";   // 预训练模型的路径
local vocab_path="adabrain/tests/data/vocabulary";
local max_enc_len=64;
local max_dec_len=10;
local max_turn_len=3;
local do_lower_case=true;
local index_name="bert";
local padding_token="[PAD]";
local oov_token="@@UNKNOWN@@";
// model相关参数
// encoder参数
local encoder_embedding_size=768;   // albert_tiny为312，bert_base为768
// decoder参数
local decoder_type="transformer";
local decoder_num_layers=2;
local feedforward_hidden_dim=3072;    // albert_tiny的中间FFN层的参数为1248
...
{
  "train_data_path": "adabrain/summarization/resolution/test_fixtures/test_pointer_rewrite.txt",        // 训练集数据
  "validation_data_path": "adabrain/summarization/resolution/test_fixtures/test_pointer_rewrite.txt",    // 测试集数据
